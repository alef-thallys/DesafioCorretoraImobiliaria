public class Apartamento extends Imovel {
	...
	public Apartamento(Long id, String endereco, String numero, String andar, boolean alugado, int valorAluguel, Proprietario proprietario) {
		super(id, endereco, numero, alugado, valorAluguel, proprietario);
		this.andar = andar;
	}
	
	public Apartamento(Long id, String endereco, String numero, String andar, boolean alugado, int valorAluguel) {
